...
public class AdminController {
    ...
    @RequestMapping(value = "/base/page/admin")
    public String home(Model model) {
    	model.addAttribute(MENU_ACTIVE, HOME);
        return "/base/page/admin";
    }
    
    @RequestMapping(value = "/base/page/admin/account", method = RequestMethod.GET)
    public ModelAndView manageAccount(HttpServletRequest request) {
    	...
    	return new ModelAndView(new RedirectView(request.getContextPath() + "/base/page/admin/user/manage/" + user.getUuid()));
    }
}
