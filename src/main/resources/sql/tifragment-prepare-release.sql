...
--
-- Inang: 127.0.0.1
-- Waktu pembuatan: 15 Apr 2014 pada 19.55
-- Versi Server: 5.5.34
-- Versi PHP: 5.4.22
...
--
-- Basis data: `tifragment`
--

-- --------------------------------------------------------

--
-- Struktur dari tabel `genidea_documentholder`
--
...
--
-- Struktur dari tabel `genidea_documentinfo`
--
...
--
-- Struktur dari tabel `genidea_group`
--
...
--
-- Struktur dari tabel `genidea_groupparticipant`
--
...
--
-- Struktur dari tabel `genidea_group_genidea_groupparticipant`
--
...
--
-- Struktur dari tabel `genidea_message`
--
...
--
-- Struktur dari tabel `genidea_messagedelivered`
--
...
--
-- Struktur dari tabel `genidea_message_tifragment_user`
--
...
--
-- Struktur dari tabel `genidea_role`
--
...
--
-- Dumping data untuk tabel `genidea_role`
--
...
--
-- Struktur dari tabel `genidea_security_code`
--
...
--
-- Dumping data untuk tabel `genidea_security_code`
--
...
--
-- Struktur dari tabel `tifragment_detail_timeframe`
--
...
--
-- Struktur dari tabel `tifragment_project`
--
...
--
-- Struktur dari tabel `tifragment_sequence`
--
...
--
-- Dumping data untuk tabel `tifragment_sequence`
--
...
--
-- Struktur dari tabel `tifragment_timeframe`
--
...
--
-- Struktur dari tabel `tifragment_user`
--
...
--
-- Dumping data untuk tabel `tifragment_user`
--
...
--
-- Ketidakleluasaan untuk tabel `genidea_group_genidea_groupparticipant`
--
...
--
-- Ketidakleluasaan untuk tabel `genidea_message_tifragment_user`
--
...
--
-- Ketidakleluasaan untuk tabel `tifragment_project`
--
